        ...
        <div class="rounded mt-4 mb-4 notification-scroll" style=" overflow-y: auto ;max-height: 30rem">
            @if ($notifications->count() > 0)
                @foreach($notifications as $notification)
                    <div
                        class="h-20  border-b-2 border-gray-600  focus:sky-800 {{ $notification->seen === "true" ?'bg-slate-700 text-gray-500 font-semibold hover:bg-slate-800':'bg-sky-900 hover:bg-sky-800 text-white font-bold' }}  cursor-pointer">
            ...
            @else
                ...
                >
                    <span class="font-extrabold text-xl text-white">No notifications yet</span>
                </div>
